...
REM Start Streamlit in the background and bind to all interfaces for LAN access.
powershell -NoProfile -Command ^
  ...
  "$args = @('-m','streamlit','run',$app,'--server.headless','true','--server.port','8501','--server.address','0.0.0.0','--browser.gatherUsageStats','false'); " ^
...
REM Give it a moment to boot, then open the UI locally.
set "READY=0"
